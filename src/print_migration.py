...
for i in range(len(paths)):
    ...
    for omega in configuration.OMEGA_LIST:
        ...
        migration_file = pd.read_csv(configuration.MIGRATION_RESULT_PATH + str(omega)+'_'+str(car_start_state)+'_'+str(car_end_state) +
        ...
        print("Ω=", omega, car_start_state, '_', car_end_state, "不迁移次数：", no_mig_count, '\n')
